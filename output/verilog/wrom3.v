...
`endif
  ...
  parameter real ACCESS_NS = 37.8895;   // clk0 rising -> dout0 valid
  parameter real T_PRE_NS  = 16.3381;   // minimum clk0 low phase
  ...
  parameter real HOLD_NS    = 37.8895;   // addr0 stable after clk0 rises
  parameter real HOLD_CS_NS = 37.8895;   // cs0 stable after clk0 rises
