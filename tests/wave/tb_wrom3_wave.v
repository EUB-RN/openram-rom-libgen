...
// DATA, not a failure.
//
// Timing below is MEASURED (SS_1p6V_100C corner, via wrom3.sv):
//     access 39.8293 ns / precharge 16.5034 ns / setup 0.0480 ns
// The cycle built from it:
//     low phase  = 16.5034 * PRE_MARGIN
//     high phase = 39.8293 * EVAL_MARGIN
//     addr0 lands = 0.0480 * SETUP_MARGIN before the rising edge
// so the period is roughly 60.1 ns -- this macro is SLOW, do not expect
...
// window is empty.
//
// VIVADO GUI: add wrom3.sv and this file to a simulation fileset, set
...
//              output/verilog/wrom3.sv tests/wave/tb_wrom3_wave.v
...
module tb_wrom3_wave;
  ...
  //     gen_wave_tb.py wrom3 --setup-margin 0.6
  //     gen_wave_tb.py wrom3 --hold-margin 0.5
  //     gen_wave_tb.py wrom3 --pre-margin 0.8 --eval-margin 0.9
  ...
  // hold_rising is the whole access (39.8293 ns), and
  ...
  // Straight out of wrom3.sv, which took them straight out of the .lib.
  localparam real T_PRE    = 16.5034;    // min_pulse_width, fall
  localparam real MPW_HIGH = 40.7543;    // min_pulse_width, rise
  localparam real ACCESS   = 39.8293;    // clk0 rise -> dout0 valid
  localparam real SETUP    = 0.0480;    // setup_rising, addr0
  localparam real HOLD     = 35.4509;    // hold_rising, addr0
  localparam real T_FALL   = 2.8806;    // falling_edge arc on dout0
  ...
  // in that gap at any margin under 1.023.
