...
// so the period is roughly 59.7 ns -- this macro is SLOW, do not expect
...
module tb_wrom0_wave;
  ...
  //     gen_wave_tb.py wrom0 --setup-margin 0.6
  //     gen_wave_tb.py wrom0 --hold-margin 0.5
  //     gen_wave_tb.py wrom0 --pre-margin 0.8 --eval-margin 0.9
  ...
  localparam real MPW_HIGH = 41.9842;    // min_pulse_width, rise
  localparam real ACCESS   = 41.0592;    // clk0 rise -> dout0 valid
  localparam real SETUP    = 0.0480;    // setup_rising, addr0
  localparam real HOLD     = 35.9700;    // hold_rising, addr0
  localparam real T_FALL   = 3.4930;    // falling_edge arc on dout0
  ...
  initial begin
    ...
    for (i = 0; i < N_READS; i = i + 1) begin
      ...
      // is 35.9700 ns rather than the full access window.
