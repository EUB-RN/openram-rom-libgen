...
// yanlis olur.
// ---------------------------------------------------------------------------
// wrom0 -- GERCEK DAVRANIS MODELI -- gen_macro_behavioral_v.py
//
...
//     python3 asic/scripts/rom_char/gen_macro_behavioral_v.py wrom0
//
...
// IKISI DE YANLIS. Bu makronun cikarilmis hucre envanterinde (wrom0/*.ext)
...
//
// GERCEK DAVRANIS (degerler wrom0'in kendi .lib'inden, ngspice ile OLCULDU)
// ---------------------------------------------------------------------------
//   clk0 = 0 : ON-SARJ. Bitline'lar VDD'ye cekilir -> dout0 = tumu 1.
//              Bu faz en az T_PRE_NS surmeli.
//   clk0 = 1 : DEGERLENDIRME. Secili satirin "0" bitleri bitline'i 82
...
//              wrom0_rom_control_logic.ext merge zincirinden dogrulandi.)
//
...
// ZAMANLAMA: SS_1p6V_100C kosesi (en kotu). Kaynak: wrom0_SS_1p6V_100C.lib
//
// SADECE SIMULASYON. Sentezlenmez; ASIC akisi wrom0_bbox.v (blackbox) okur.
// ---------------------------------------------------------------------------
`timescale 1ns / 1ps
...
`endif
  ...
  // OLCULEN degerler -- wrom0_SS_1p6V_100C.lib
  parameter real ACCESS_NS = 42.9053;   // clk0 yukselen -> dout0 gecerli
  parameter real T_PRE_NS  = 14.0193;   // clk0 dusuk fazi en az bu kadar
